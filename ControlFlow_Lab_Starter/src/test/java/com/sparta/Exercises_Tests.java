...
public class Exercises_Tests {
    ...
    public void ReturnResultBasedOnFinalGrade_Distinction(){
        Assertions.assertEquals("Pass with Distinction", Exercises.grade(80));
    }

    @Test
    @DisplayName("Final Mark based on grade")
    public void ReturnResultBasedOnFinalGrade_Merit(){
        Assertions.assertEquals("Pass with Merit", Exercises.grade(65));
    }

    @Test
    @DisplayName("Final Mark based on grade")
    public void ReturnResultBasedOnFinalGrade_Pass() {
        Assertions.assertEquals("Pass", Exercises.grade(45));
    }

    @Test
    @DisplayName("Final Mark based on grade")
    public void ReturnResultBasedOnFinalGrade_Fail() {
        Assertions.assertEquals("Fail", Exercises.grade(20));
    }
    ...
    public class WeddingTest {
        ...
        public void testLevel4() {
            assertEquals(20, Main.getScottishMaxWeddingNumber(4));
        }

        @Test
        public void testLevel3() {
            assertEquals(50, Main.getScottishMaxWeddingNumber(3));
        }

        @Test
        public void testLevel2() {
            assertEquals(50, Main.getScottishMaxWeddingNumber(2));
        }

        @Test
        public void testLevel1() {
            assertEquals(100, Main.getScottishMaxWeddingNumber(1));
        }

        @Test
        public void testLevel0() {
            assertEquals(200, Main.getScottishMaxWeddingNumber(0));
        }

        @Test
        public void testInvalidLevel() {
            assertEquals(0, Main.getScottishMaxWeddingNumber(5)); // or -1
        }
    }
}
